...
import { GradeHorarioOfertaFormacaoService } from "./services.gen";
import { GradeHorarioOfertaFormacaoIntervaloDeTempoService } from "./services.gen";
...
import { NivelFormacaoService } from "./services.gen";
import { OfertaFormacaoService } from "./services.gen";
import { OfertaFormacaoNivelFormacaoService } from "./services.gen";
...
export class LadesaApiClient {
  ...
  public readonly gradeHorarioOfertaFormacao: GradeHorarioOfertaFormacaoService;
  public readonly gradeHorarioOfertaFormacaoIntervaloDeTempo: GradeHorarioOfertaFormacaoIntervaloDeTempoService;
  ...
  public readonly nivelFormacao: NivelFormacaoService;
  public readonly ofertaFormacao: OfertaFormacaoService;
  public readonly ofertaFormacaoNivelFormacao: OfertaFormacaoNivelFormacaoService;
  ...
  constructor(config?: Partial<OpenAPIConfig>, HttpRequest: HttpRequestConstructor = FetchHttpRequest) {
    ...
    this.gradeHorarioOfertaFormacao = new GradeHorarioOfertaFormacaoService(this.request);
    this.gradeHorarioOfertaFormacaoIntervaloDeTempo = new GradeHorarioOfertaFormacaoIntervaloDeTempoService(this.request);
    ...
    this.nivelFormacao = new NivelFormacaoService(this.request);
    this.ofertaFormacao = new OfertaFormacaoService(this.request);
    this.ofertaFormacaoNivelFormacao = new OfertaFormacaoNivelFormacaoService(this.request);
